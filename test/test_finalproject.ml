...
let note_tests =
  ...
  >::: [
         ...
         ( "note calcualtion of score check - Perfect" >:: fun _ ->
           assert_equal 90 (calc_score sample_note 3 Perfect) );
         ( "note calcualtion of score check - Great" >:: fun _ ->
           assert_equal 60 (calc_score sample_note 3 Great) );
         ( "note calcualtion of score check - Good" >:: fun _ ->
           assert_equal 30 (calc_score sample_note 3 Good) );
         ( "note calcualtion of score check - Miss" >:: fun _ ->
           assert_equal 0 (calc_score sample_note 3 Miss) );
         ( "note calcualtion of accuracy check - Perfect" >:: fun _ ->
           assert_equal Perfect (calc_accuracy sample_note 10) );
         ( "note calcualtion of accuracy check - Great" >:: fun _ ->
           assert_equal Great (calc_accuracy sample_note 300) );
         ( "note calcualtion of accuracy check - Good" >:: fun _ ->
           assert_equal Good (calc_accuracy sample_note 500) );
         ( "note calcualtion of accuracy check - Miss" >:: fun _ ->
           assert_equal Miss (calc_accuracy sample_note 1000) );
         ( "note try_hit - true" >:: fun _ ->
           assert_equal true (try_hit sample_note 400) );
         ( "note try_hit - false" >:: fun _ ->
